...
export const { useFindGeoLayerQuery } = injectFindById<GeoLayer>('findGeoLayer', endpoint);
...
export const { useCreateGeoLayerMutation } = injectCreate<GeoLayer, CreateGeoLayerDto>(
  'createGeoLayer',
  endpoint
);

export const { useUpdateGeoLayerMutation } = injectUpdate<GeoLayer, UpdateGeoLayerDto>(
  'updateGeoLayer',
  endpoint
);
